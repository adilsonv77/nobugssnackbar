...
public class TestInsertDescription {
	...
	public static void main(String[] args) throws Exception {
		...
		PreparedStatement ps = con.prepareStatement("update questionstest set testquestiondescription = ? where testquestionid = 3");
		
		byte[] encoded = Files.readAllBytes(Paths.get("C:\\Users\\adilsonv77\\Downloads\\questiondescription3.txt"));
