...
nobugspage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="SnackMan_goToCustomerTooltip">Moves the snack man to the customer.</span><span id="SnackMan_askForFoodTooltip">Asks the customer about his order.</span><span id="SnackMan_goToDisplayTooltip">Moves the snack man to the display.</span><span id="SnackMan_goToCoolerTooltip">Moves the snack man to the cooler.</span><span id="SnackMan_doesntExistCustomer">Wrong position</span><span id="NoBugs_unloadWarning">Leaving this page will result in the loss of your work.</span></div>';
};
