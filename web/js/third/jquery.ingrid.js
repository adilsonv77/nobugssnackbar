...
jQuery.fn.ingrid = function(o){
	...
	g.extend({
		...
		resize : function() {
			...
			// Adilson: tive que alterar esse trecho pois nao funcionava com mais de uma tabela
			var outer_w = cfg.scrollbarW;
			this.getHeaders().each(function(i){
				var cssCol = jQuery(this).css('width');
				cssCol = cssCol.substr(0, cssCol.indexOf("px")) ;
				outer_w += parseInt(cssCol);
			});
			
			b.width(outer_w);
			b.css("width", outer_w + "px");
			b.children().css("width", outer_w + "px")
