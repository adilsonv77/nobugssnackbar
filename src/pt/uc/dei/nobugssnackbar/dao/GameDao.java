...
public interface GameDao {
	...
	List<Map<String, String>> loadUsersInTheMission(long clazzId, int missionId, String[] listOfUsers) throws Exception;
	...
	void markWizardFreeConsumed(long user, long mission, int attempts,
			int timeSpend, boolean consumeStars) throws Exception;
