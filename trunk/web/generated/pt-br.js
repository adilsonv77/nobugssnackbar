...
nobugspage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return apps.messages(null, null, opt_ijData) + '<div style="display: none"><span id="SnackMan_goToCustomerTooltip">Move o cozinheiro ate o balcao.</span><span id="SnackMan_askForFoodTooltip">Pergunto ao cliente o que ele deseja.</span><span id="SnackMan_goToDisplayTooltip">Move o cozinheiro ate o mostrador.</span><span id="SnackMan_goToCoolerTooltip">Moves the snack man to the cooler.</span><span id="SnackMan_doesntExistCustomer">Wrong position</span><span id="NoBugs_unloadWarning">Deixar essa pagina resulta em perdas no trabalho.</span></div>';
};
...
nobugspage.toolbox = function(opt_data, opt_ignored, opt_ijData) {
  return '<xml id="toolbox" style="display: none"><category name="SnackMan"><block type="move_goToCustomer"><value name="VALUE"><block type="math_number"><field name="NUM">1</field></block></value></block><block type="ask_askForFood"> </block><block type="move_goToDisplay"> </block><block type="move_goToCooler"> </block></category><category name="Condicionais"><block type="controls_if"></block><block type="logic_compare"></block><block type="logic_operation"></block><block type="logic_negate"></block><block type="logic_boolean"></block></category><category name="Lacos"><block type="controls_whileUntil"></block><block type="controls_for"><value name="FROM"><block type="math_number"><field name="NUM">1</field></block></value><value name="TO"><block type="math_number"><field name="NUM">10</field></block></value><value name="BY"><block type="math_number"><field name="NUM">1</field></block></value></block></category><category name="Math"><block type="math_number"></block></category><category name="Variaveis" custom="VARIABLE"></category></xml>';
};
